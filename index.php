<?php
    ...
    $profession="Dev";
    $career = [
    ["job" => "Учитель", "year" => "2020 - по настоящее время", "skills" => "Учу детей уму разуму"],
    ["job" => "Инженер", "year" => "2016 - 2020", "skills" => "Создавал авиадвигатели"],
    ["job" => "Капитан танкера", "year" => "2014 - 2016", "skills" => "Возил нефть по всему миру"],
    ];
?>
...
<div class="w3-content w3-margin-top" style="max-width:1400px;">
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
        ...
        <h5><?php for($i=0; $i < count($career); $i++) : ?>
        	<p>
        		<div class="w3-container">
      			<h5 class="w3-opacity"><b> 
        	<?php echo $career[$i]["job"]; ?>
        	</p>
      	</b></h5>
